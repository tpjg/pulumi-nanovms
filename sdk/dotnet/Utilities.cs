...
namespace Tpjg.Nanovms
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Tpjg.Nanovms.version.txt");
    ...
    internal sealed class NanovmsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NanovmsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
