...
namespace Tpjg.PulumiNanovms
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Tpjg.PulumiNanovms.version.txt");
    ...
    internal sealed class PulumiNanovmsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PulumiNanovmsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
