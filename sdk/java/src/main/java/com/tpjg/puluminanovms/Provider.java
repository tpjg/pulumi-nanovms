...
import com.tpjg.puluminanovms.ProviderArgs;
import com.tpjg.puluminanovms.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:pulumi-nanovms")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pulumi-nanovms", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
